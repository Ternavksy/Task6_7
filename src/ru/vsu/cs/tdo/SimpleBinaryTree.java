...
import ru.vsu.cs.shepliakovvladislavvyacheslavovich.BinaryTree.TreeNode;
/**
 * Реализация простейшего бинарного дерева
 */
public class SimpleBinaryTree<T> implements ru.vsu.cs.shepliakovvladislavvyacheslavovich.BinaryTree<T> {
